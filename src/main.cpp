...
//putter
glm::vec3 putter_center_position(0.0f, 0.0f, 0.0f); // the position of the center of the putter (the intercetion of hitting part and rod)
...
glm::vec3 hitting_part_center_position(-0.5f, 0.4f, 0.0f); // the position of the center of the hitting part

// rod
glm::vec3 rod_center_position(0.0f, 3.0f, 0.0f); // the position of the center of the rod
...
void initOpenGL() {
   ...
   *        Ex. HW1 - 311550000
   */
  glfwSetWindowTitle(window, "HW1 - 111550079"); // name the window title
